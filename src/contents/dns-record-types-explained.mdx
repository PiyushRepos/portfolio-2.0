...
- [DNS Made Easy: DNS Record Types](https://www.dnsmadeeasy.com/support/dns-record-types/)
- [Cloudflare Learning Center: DNS Records](https://www.cloudflare.com/learning/dns/dns-records/)
- [ICANN: Understanding DNS](https://www.icann.org/resources/pages/dns-2013-09-17-en)
